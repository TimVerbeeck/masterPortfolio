  ...
  data: [
    ...
    },
    {
      ...
      skills: [
        ...
        "Bij de seminaries heb ik veel bijgeleerd op vlak van programmeren. Ik heb de seminaries in mijn eerste jaar I-Talent gekozen op basis van mijn interesses. Hoewel er sommige seminaries waren die ik liever had gedaan toen, maar niet heb kunnen doen omdat er geen plaatsen meer waren. Zo had ik bijvoorbeeld ook nog graag het seminarie over Flutter meegedaan. In mijn tweede jaar heb ik meer gekeken naar de lengte van het seminarie als ik eerlijk ben. Maar de seminaries die ik toen gevolgd had waren eerlijk gezegd nog de interessantste. Dit komt doordat ik geen verwachtingen had op voorhand toen ik ze gekozen had. En hierdoor heb ik ook meer bijgeleerd over onderwerpen die in eerste instantie niet binnen mijn interesses vielen.",
        ...
        "Het I-Talent avontuur heeft me doen inzien dat levenslang leren een noodzaak is in mijn verdere carrière. Mijn visie hierop is dat streven om een beetje beter te zijn dan gisteren beter is dan helemaal niets te doen.",
      ],
      softwareSkills: [],
    },
    {
    ...
    },
    {
      ...
      skills: [
        ...
        "Doorheen mijn opleiding heb ik veel ervaring en kennis opgedaan. Hiermee kan ik met overtuiging zeggen dat ik met zekerheid het Multi- & disciplinariteit onderdeel bezit. Ik kan van alle aspecten die bij het maken van een applicatie horen wel iets. Ook heb ik ervaring in de cyber security. Verder sta ik ook nog open om bij te leren op allerlei vlakken.",
      ],
      softwareSkills: [],
    },
    {
